...
| `BEGINNER-GUIDE.md` | 面向第一次使用者的操作手册 |
| `SOP.md` | 场景索引与流程入口 |
| `ai/index.md` | AI 规则入口 |
...
| 根目录 `BEGINNER-GUIDE.md` | 初学者操作手册 | 规则正文、项目业务事实 |
| 根目录 `TEMPLATE-METHODOLOGY.md` | 模板设计说明 | 派生项目过程文档 |
