...
- v1.6.5（2026-06-23）：新增 GitHub Actions PR 自检，自动运行 `git diff --check` 与 `bash scripts/check-template.sh`；README 增加“5 分钟最小路径（愿景 → 本机 Demo）”，明确先采集 `docs/env/local-env.md`，再由 `docs/vision/product-vision.md` 驱动 AI 生成 `docs/00-09` 与 Sprint1。
