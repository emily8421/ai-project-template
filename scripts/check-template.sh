...
require_new_project_local_smoke() {
  ...
  require_absent_file "$project_dir/template-docs/maintainer/e2e-regression-checklist.md" "new-project 烟测 template-docs/ 不含模板仓专用 e2e-regression-checklist.md"
...
check_script_entrypoints() {
  ...
  require_contains "template-docs/templates/derived-sync-report-template.md" 'PowerShell fallback' "同步运行记录模板记录 fallback"
}
...
require_contains "template-docs/profiles/domain-templates.md" 'upstream/CHANGELOG\.md' "领域模板说明 upstream changelog 继承参考"
...
require_contains "template-sync.json" '"template-docs/templates/session-handoff.example.md"' "template-sync 同步会话续接样例"
require_contains "template-sync.json" '"template-docs/templates/derived-sync-report-template.md"' "template-sync 同步派生同步运行记录模板"
...
require_file "template-docs/templates/smoke-test-report-template.md"
require_file "template-docs/templates/derived-sync-report-template.md"
...
require_file "template-docs/templates/session-handoff.example.md"
...
require_contains "template-docs/beginner-guide.md" 'template-docs/templates/smoke-test-report-template.md' "BEGINNER-GUIDE 指向烟测记录模板"
...
require_contains "template-docs/smoke-test.md" 'template-docs/templates/smoke-test-report-template.md' "SMOKE-TEST 指向烟测记录模板"
require_contains "template-docs/templates/smoke-test-report-template.md" '本轮烟测是否通过' "烟测记录模板包含最终结论"
...
require_contains "scripts/sync-template.sh" '"template-docs/templates/derived-sync-report-template.md"' "sync-template 兜底清单含派生同步运行记录模板"
...
require_contains "template-docs/profiles/domain-templates.md" 'domain-template-lab' "domain-templates 指向 AI 可执行实验入口"
...
require_contains "template-docs/templates/session-handoff.example.md" 'AI Session Handoff Example' "会话续接样例标题正确"
require_contains "template-docs/templates/derived-sync-report-template.md" '派生项目模板同步运行记录' "派生同步运行记录模板标题正确"
...
require_contains "template-docs/maintainer/e2e-regression-checklist.md" 'R6' "e2e 回归清单含 R6 PowerShell fallback 项"
...
require_contains "template-docs/templates/derived-sync-report-template.md" '命令真实性记录' "同步报告模板包含命令真实性记录"
require_contains "template-docs/templates/derived-sync-report-template.md" '不得自动归档' "同步报告模板约束提案收口不得仅凭 closed"
require_contains "template-docs/templates/derived-sync-report-template.md" '同步后整理摘要' "同步报告模板包含整理摘要"
require_contains "template-docs/templates/derived-sync-report-template.md" '文档体系审计摘要' "同步报告模板包含文档审计摘要"
require_contains "template-docs/templates/derived-sync-report-template.md" '项目验证建议' "同步报告模板包含项目验证建议"
...
require_contains "template-docs/templates/docs-open-items.example.md" '待确认事项总览示例' "open items 示例模板存在"
...
require_contains "template-sync.json" 'template-docs/templates/docs-open-items.example.md' "同步清单包含 open items 示例"
...
require_contains "template-docs/templates/session-handoff.example.md" 'Updated at' "会话续接样例包含元数据"
...
require_contains "template-docs/templates/ui-prototype-exploration-template.md" '需求探索原型记录模板' "需求探索原型模板存在"
require_contains "template-docs/templates/ui-prototype-strategy-template.md" 'UI 原型策略 / 实现前原型记录模板' "UI 原型策略模板存在"
...
require_contains "template-sync.json" 'template-docs/templates/ui-prototype-exploration-template.md' "同步清单包含需求探索原型模板"
require_contains "template-sync.json" 'template-docs/templates/ui-prototype-strategy-template.md' "同步清单包含 UI 原型策略模板"
require_contains "template-sync.json" 'template-docs/templates/ui-brief-intake-template.md' "同步清单包含 UI Brief Intake 模板"
require_contains "template-sync.json" 'template-docs/templates/frontend-experience-brief-template.md' "同步清单包含前端体验 brief 模板"
require_contains "template-sync.json" 'template-docs/profiles/web-fullstack-profile.md' "同步清单包含 Web fullstack profile"
require_contains "template-sync.json" 'template-docs/profiles/web-app-scaffold-experiment.md' "同步清单包含 Web app scaffold 实验协议"
require_contains "scripts/sync-template.sh" 'template-docs/templates/ui-brief-intake-template.md' "sync-template fallback 包含 UI Brief Intake 模板"
require_contains "scripts/sync-template.sh" 'template-docs/templates/frontend-experience-brief-template.md' "sync-template fallback 包含前端体验 brief 模板"
require_contains "scripts/sync-template.sh" 'template-docs/profiles/web-fullstack-profile.md' "sync-template fallback 包含 Web fullstack profile"
require_contains "scripts/sync-template.sh" 'template-docs/profiles/web-app-scaffold-experiment.md' "sync-template fallback 包含 Web app scaffold 实验协议"
require_file "template-docs/templates/frontend-ui-reference-analysis-template.md"
require_contains "template-docs/templates/frontend-ui-reference-analysis-template.md" '采纳 / 调整 / 排除矩阵' "前端参考分析模板包含采纳排除矩阵"
require_contains "template-docs/templates/frontend-ui-reference-analysis-template.md" 'UI-G-002' "前端参考分析模板引用 UI-G-002"
...
require_file "template-docs/ui-knowledge/source-registry.md"
require_contains "template-docs/ui-knowledge/source-registry.md" 'SRC-A11Y-001' "来源索引登记 W3C WAI-ARIA 来源"
require_file "template-docs/ui-knowledge/visual-patterns.md"
require_contains "template-docs/ui-knowledge/visual-patterns.md" 'PAT-VIS-' "视觉模式使用 PAT-VIS 编号"
require_file "template-docs/ui-knowledge/interaction-patterns.md"
require_contains "template-docs/ui-knowledge/interaction-patterns.md" 'PAT-INT-' "交互模式使用 PAT-INT 编号"
require_contains "template-sync.json" 'template-docs/templates/frontend-ui-reference-analysis-template.md' "同步清单包含前端参考分析模板"
require_contains "template-sync.json" 'template-docs/ui-knowledge/README\.md' "同步清单包含 UI 知识 README"
require_contains "template-sync.json" 'template-docs/ui-knowledge/source-registry\.md' "同步清单包含来源索引"
require_contains "template-sync.json" 'template-docs/ui-knowledge/visual-patterns\.md' "同步清单包含视觉模式"
...
require_contains "scripts/sync-template.sh" 'template-docs/templates/frontend-ui-reference-analysis-template.md' "sync-template fallback 包含前端参考分析模板"
check_ui_knowledge_structure
require_file "template-docs/templates/frontend-experience-brief-template.md"
require_contains "template-docs/templates/frontend-experience-brief-template.md" '已确认体验原则' "前端体验 brief 模板包含已确认体验原则"
require_file "template-docs/templates/ui-brief-intake-template.md"
require_contains "template-docs/templates/ui-brief-intake-template.md" '交互体验抽取表' "UI Brief Intake 模板包含交互体验抽取表"
require_file "template-docs/profiles/web-fullstack-profile.md"
require_contains "template-docs/profiles/web-fullstack-profile.md" 'WSG-001' "Web fullstack profile 定义 WSG gates"
require_contains "template-docs/profiles/web-fullstack-profile.md" '文件膨胀阈值' "Web fullstack profile 定义文件膨胀阈值"
require_file "template-docs/profiles/web-app-scaffold-experiment.md"
require_contains "template-docs/profiles/web-app-scaffold-experiment.md" 'Promotion decision matrix' "Web app scaffold 实验协议定义推广决策矩阵"
require_contains "template-docs/profiles/web-app-scaffold-experiment.md" '不在母模板内直接生成' "Web app scaffold 实验协议禁止母模板直接内置 scaffold"
require_contains "template-docs/profiles/web-fullstack-profile.md" 'web-app-scaffold-experiment\.md' "Web fullstack profile 链接 scaffold 实验协议"
...
require_contains "template-docs/profiles/web-fullstack-profile.md" 'System Skeleton' "Web fullstack profile 定位为 System Skeleton 的 Web 特化"
require_contains "template-docs/profiles/domain-templates.md" 'web-app-scaffold-experiment\.md' "领域模板说明引用 Web app scaffold 实验"
...
require_file "template-docs/profiles/remote-ci-sop-profile.md"
require_contains "template-docs/profiles/remote-ci-sop-profile.md" 'PR / CI 闭环 Checklist' "Remote / CI profile 包含 PR/CI 闭环 checklist"
require_contains "template-docs/profiles/remote-ci-sop-profile.md" 'CI pending 即汇报 pending' "Remote / CI profile 约束 CI pending 不长等"
require_contains "template-docs/profiles/remote-ci-sop-profile.md" 'Invoke-WebRequest' "Remote / CI profile 推荐 Windows 下原始 REST JSON 查询"
require_contains "template-docs/profiles/remote-ci-sop-profile.md" '未确认不做 push / merge / close / delete / release' "Remote / CI profile 保留高风险确认边界"
require_contains "ai/index.md" 'template-docs/profiles/remote-ci-sop-profile.md' "任务路由包含 Remote / CI profile"
require_contains "ai/commands/README.md" 'template-docs/profiles/remote-ci-sop-profile.md' "命令索引包含 Remote / CI profile"
require_contains "template-sync.json" 'template-docs/profiles/remote-ci-sop-profile.md' "同步清单包含 Remote / CI profile"
require_contains "scripts/sync-template.sh" 'template-docs/profiles/remote-ci-sop-profile.md' "sync-template fallback 包含 Remote / CI profile"
...
require_contains "docs/README.md" 'template-docs/profiles/web-fullstack-profile.md' "docs README 记录 Web fullstack profile 边界"
...
require_contains "template-sync.json" 'template-docs/profiles/domain-templates.md' "同步清单包含领域模板方法论文档"
require_contains "template-sync.json" 'template-docs/maintainer/domain-derived-scenarios-template.md' "同步清单（files_domain）包含领域派生项目场景剧本模板"
require_file "template-docs/profiles/domain-templates.md"
require_file "template-docs/maintainer/domain-derived-scenarios-template.md"
require_contains "template-docs/profiles/domain-templates.md" '可选中间层' "领域模板文档定位为可选中间层"
require_contains "template-docs/profiles/domain-templates.md" '母模板 → 领域模板 → 项目' "领域模板文档定义三层继承模型"
require_contains "template-docs/profiles/domain-templates.md" '主线治理仍为两层' "领域模板文档声明主线仍为两层（防回退为强制三层）"
require_contains "template-docs/profiles/domain-templates.md" 'domain/scenarios\.md' "领域模板文档定义 L2→L3 场景剧本入口"
require_contains "template-docs/profiles/domain-templates.md" 'domain-derived-scenarios-template\.md' "领域模板文档指向 L2→L3 通用骨架"
require_contains "template-docs/maintainer/domain-derived-scenarios-template.md" 'L2-to-L3 playbook template' "领域派生项目场景剧本模板声明英文稳定定位"
require_contains "template-docs/maintainer/domain-derived-scenarios-template.md" 'domain/scenarios\.md' "领域派生项目场景剧本模板说明复制目标"
require_contains "template-docs/maintainer/domain-derived-scenarios-template.md" '适用性判断' "领域派生项目场景剧本模板覆盖适用性判断"
require_contains "template-docs/maintainer/domain-derived-scenarios-template.md" '发布后的下游同步' "领域派生项目场景剧本模板覆盖发布后下游同步"
...
require_contains "ai/prompts/maintainers/23-domain-template-lab.md" 'domain/scenarios\.md' "domain-template-lab Prompt 收录领域派生项目场景剧本资产"
...
require_file "template-docs/templates/demo-runbook-template.md"
require_contains "template-docs/templates/demo-runbook-template.md" '不替代' "demo-runbook 模板声明不替代 09 验收"
require_contains "template-docs/templates/demo-runbook-template.md" 'identity marker' "demo-runbook 模板包含页面身份标记"
require_contains "template-docs/templates/demo-runbook-template.md" 'local-demo-runtime\.json' "demo-runbook 模板包含运行状态文件忽略口径"
require_contains "template-docs/templates/demo-runbook-template.md" '默认端口只是示例' "demo-runbook 模板区分默认端口和实际入口"
require_contains "template-docs/templates/demo-runbook-template.md" 'Repair-ProcessPathEnvironment' "demo-runbook 模板含 Windows Path/PATH 归一化复用指引（#296）"
require_contains "template-docs/templates/demo-runbook-template.md" 'WindowStyle Hidden' "demo-runbook 模板含 Windows 后台启动 -WindowStyle Hidden 指引（#296）"
...
require_contains "template-sync.json" 'template-docs/templates/demo-runbook-template.md' "同步清单包含 demo runbook 模板"
...
require_contains "template-docs/templates/demo-runbook-template.md" '回滚与清理' "demo runbook 含回滚清理章节（DM-1）"
require_file "template-docs/templates/user-guide-template.md"
require_contains "template-docs/templates/user-guide-template.md" '任务 → 权威入口' "user-guide 模板含任务导航表（DM-1）"
require_contains "template-sync.json" 'template-docs/templates/user-guide-template.md' "同步清单含 user-guide 模板"
require_contains "template-docs/beginner-guide.md" 'user-guide-template' "新手指南导航含 user-guide（防漂移）"
require_file "template-docs/maintainer/rd-data-chain.md"
require_contains "template-docs/maintainer/rd-data-chain.md" '数据类别' "rd-data-chain 含数据类别索引（RC-1）"
if grep -qF '"template-docs/maintainer/rd-data-chain.md"' template-sync.json; then
...
check_scripts_sync_boundary() {
  ...
  local template_only_docs=(
    "template-docs/maintainer/e2e-regression-checklist.md"
    "template-docs/maintainer/e2e-report-template.md"
    "template-docs/maintainer/rd-data-chain.md"
  )
...
sys.exit(0 if ('template-docs/maintainer/domain-derived-scenarios-template.md' in d.get('files_domain', [])
               and 'template-docs/maintainer/domain-derived-scenarios-template.md' not in d['files_all']) else 1)
" 2>/dev/null; then
