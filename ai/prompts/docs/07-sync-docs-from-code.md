...
3. 对仍在边界内的差异，更新 docs/ 中受影响的文档（如 06-db-design.md / 07-api-spec.md），使文档与实际实现一致
4. 若实现结果包含验证事实、Sprint 完成状态、缺陷 / 回归结果、Mock / 降级条件通过或残留风险，必须说明对 `docs/08-dev-plan.md`、`docs/09-verification.md` 和 handoff 的回写影响；长期事实不得只留在 handoff 或 PR 描述中
5. 说明更新了哪些文档、哪些章节，以及追溯链是否仍完整
