...
> 维护者侧索引，**不下行同步**。版本字段是 point-in-time 快照，live 以各项目 `VERSION` + `TEMPLATE-BASE.md` 为准。更新：2026-07-24。
...
| LUMEN-DEMO | ordinary | emily8421/LUMEN-DEMO | ai-project-template | v1.54.1 | v1.47.1 | 2026-07-17 | active | 本地路径：`D:\2-Project\0-Product\3-LUMEN_KnowledgeBase\LUMEN_demo_T2.1`；2026-07-17 同步 v1.54.1（PR LUMEN-DEMO#81，squash）；VERSION v1.47.1 为项目自有版本（双版本机制正常，非异常）；版本机制未完整启用（project-check.yml/project-rules 缺），post-sync-cleanup 待办 |
