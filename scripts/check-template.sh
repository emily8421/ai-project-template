...
require_contains "template-docs/profiles/domain-templates.md" 'domain-derived-scenarios\.md' "领域模板文档定义 L2→L3 场景剧本入口"
...
require_contains "template-docs/maintainer/domain-derived-scenarios-template.md" 'domain-derived-scenarios\.md' "领域派生项目场景剧本模板说明复制目标"
