...
可选 mermaid 上下文图示例（图 ID `DIAG-ARCH-01`，替代 / 补充上方 ASCII，对齐 `ai/document-lifecycle-rules.md` §13 默认 mermaid）：
...
|---|---|---|---|---|---|---|---|
| COMP-001 |  |  | 本机 / 服务器 / Docker / 浏览器 |  | [P1] | 设计骨架 / P1-已设计 / Mock / 默认关闭 | REQ-001 / NFR-001 |
