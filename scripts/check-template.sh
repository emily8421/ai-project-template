...
require_file "BEGINNER-GUIDE.md"
require_file "ENV-SETUP.md"
require_file "AI-CLI-SETUP.md"
require_file "SMOKE-TEST.md"
require_file "SMOKE-TEST-REPORT-TEMPLATE.md"
...
require_contains "README.md" 'v1\.16\.0' "README 最近版本摘要包含 v1.16.0"
require_contains "README.md" '阶段路线图、交付物形态' "README 最小路径提醒确认交付物形态"
require_contains "README.md" 'AI-CLI-SETUP\.md' "README 包含 AI CLI 安装入口"
require_contains "BEGINNER-GUIDE.md" 'ENV-SETUP\.md' "BEGINNER-GUIDE 指向环境准备手册"
require_contains "BEGINNER-GUIDE.md" 'SMOKE-TEST\.md' "BEGINNER-GUIDE 指向新手烟测"
require_contains "BEGINNER-GUIDE.md" 'SMOKE-TEST-REPORT-TEMPLATE\.md' "BEGINNER-GUIDE 指向烟测记录模板"
require_contains "BEGINNER-GUIDE.md" 'lemesh_ai_model' "BEGINNER-GUIDE 指向公司中转站手册"
require_contains "BEGINNER-GUIDE.md" '官方文档安装并登录 `Claude CLI` 或 `Codex CLI`' "BEGINNER-GUIDE 区分 CLI 安装与中转站配置"
require_contains "BEGINNER-GUIDE.md" 'AI-CLI-SETUP\.md' "BEGINNER-GUIDE 指向 AI CLI 安装文档"
require_contains "ENV-SETUP.md" 'bootstrap-dev-env\.ps1' "ENV-SETUP 指向一键安装脚本"
require_contains "ENV-SETUP.md" 'check-prereqs\.ps1' "ENV-SETUP 指向前置检测脚本"
require_contains "ENV-SETUP.md" 'Claude CLI' "ENV-SETUP 包含 Claude CLI 说明"
require_contains "ENV-SETUP.md" 'Codex CLI' "ENV-SETUP 包含 Codex CLI 说明"
require_contains "ENV-SETUP.md" 'lemesh_ai_model' "ENV-SETUP 指向公司中转站手册"
require_contains "ENV-SETUP.md" '不应被理解为 `Claude CLI` 或 `Codex CLI` 本身的官方安装指南' "ENV-SETUP 区分中转站手册与 CLI 安装指南"
require_contains "AI-CLI-SETUP.md" 'claude --version' "AI-CLI-SETUP 包含 Claude CLI 启动验证"
require_contains "AI-CLI-SETUP.md" 'codex --version' "AI-CLI-SETUP 包含 Codex CLI 启动验证"
require_contains "AI-CLI-SETUP.md" 'lemesh_ai_model' "AI-CLI-SETUP 指向公司中转站手册"
require_contains "SMOKE-TEST.md" 'scripts/check-prereqs\.ps1' "SMOKE-TEST 包含环境检查脚本"
require_contains "SMOKE-TEST.md" 'scripts/new-project\.sh smoke-demo --local --no-remote' "SMOKE-TEST 包含本地烟测项目创建"
require_contains "SMOKE-TEST.md" 'scripts/collect-env\.ps1' "SMOKE-TEST 包含环境采集"
require_contains "SMOKE-TEST.md" 'SMOKE-TEST-REPORT-TEMPLATE\.md' "SMOKE-TEST 指向烟测记录模板"
require_contains "SMOKE-TEST-REPORT-TEMPLATE.md" '本轮烟测是否通过' "烟测记录模板包含最终结论"
