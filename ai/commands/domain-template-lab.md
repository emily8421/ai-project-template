...
5. 若当前正在创建或更新领域模板实验线，必须规划该领域模板自己的 L2→L3 场景剧本（L2-to-L3 playbook，如 `template-docs/<domain>/domain-derived-scenarios.md`），覆盖领域派生项目创建、同步、整理、自检、回流和发布后下游同步；未生成时在计划和续接中列为待办。
