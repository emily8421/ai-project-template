...
function Invoke-NativeTemplateCheck {
  ...
  Require-Contains "ai/commands/sync-methodology.md" "A13 完成判据矩阵" "sync-methodology requires A13 completion gate matrix"
  Require-Contains "ai/prompts/maintainers/12-sync-template.md" "收尾门禁" "12-sync-template prompt includes A13 closure gate"
  Require-Contains "template-docs/derived-sync-report-template.md" "命令真实性记录" "sync report records command authenticity"
  Require-Contains "template-docs/derived-sync-report-template.md" "不得自动归档" "sync report prevents proposal closeout by closed state only"
  ...
  Require-Contains "ai/commands/README.md" "domain-template-lab" "commands README includes domain template lab"
  Require-Contains "ai/commands/domain-template-lab.md" "23-domain-template-lab\.md" "domain-template-lab command routes to prompt"
  Require-Contains "ai/prompts/maintainers/23-domain-template-lab.md" "只相邻同步，不跨层操作" "domain-template-lab prompt defines adjacent-layer sync"
  Require-Contains "template-docs/domain-templates.md" "domain-template-lab" "domain templates doc links AI executable lab entry"
  Require-Contains "template-sync.json" "ai/commands/domain-template-lab\.md" "template-sync includes domain-template-lab command"
  Require-Contains "template-sync.json" "ai/prompts/maintainers/23-domain-template-lab\.md" "template-sync includes domain-template-lab prompt"
  Require-Contains "scripts/sync-template.sh" "ai/commands/domain-template-lab\.md" "sync-template fallback includes domain-template-lab command"
  Require-Contains "scripts/sync-template.sh" "ai/prompts/maintainers/23-domain-template-lab\.md" "sync-template fallback includes domain-template-lab prompt"
  ...
  Require-Contains "ai/session-rules.md" "同会话规则复用边界" "session rules define same-session rule reuse boundary"
  Require-Contains "ai/session-rules.md" "后续顺序治理步骤可复用已加载规则" "session rules scope same-session rule reuse"
  Require-Contains "ai/session-rules.md" "验证证据摘要约定" "session rules define validation evidence summary convention"
  ...
  Require-Contains "scripts/sync-template.sh" "TEMPLATE-BASE\.md" "sync-template maintains derived project template lineage"
  Require-Contains "scripts/sync-template.sh" "--domain-template" "sync-template supports domain template role preserving VERSION/CHANGELOG"
  Require-Contains "scripts/sync-template.sh" "write_domain_template_base" "sync-template maintains domain TEMPLATE-BASE.md"
  Require-Contains "scripts/sync-template.sh" "extract_legacy_domain_standards_scope" "sync-template migrates legacy domain TEMPLATE-BASE standards scope"
  Require-Contains "scripts/sync-template.sh" "叠加的标准件范围" "sync-template supports legacy Chinese domain standards heading"
  Require-Contains "scripts/sync-template.ps1" "--preserve-project-version" "sync-template PowerShell fallback supports preserving derived project VERSION"
  Require-Contains "scripts/sync-template.ps1" "Get-LineageRole" "sync-template PowerShell fallback auto-detects TEMPLATE-BASE lineage role"
  Require-Contains "scripts/sync-template.ps1" "--domain-template" "sync-template PowerShell fallback supports domain template role"
  Require-Contains "scripts/sync-template.ps1" "Write-DomainTemplateBase" "sync-template PowerShell fallback maintains domain TEMPLATE-BASE.md"
  Require-Contains "scripts/sync-template.ps1" "Get-LegacyDomainStandardsScope" "sync-template PowerShell fallback migrates legacy domain TEMPLATE-BASE standards scope"
  Require-Contains "scripts/sync-template.ps1" "叠加的标准件范围" "sync-template PowerShell fallback supports legacy Chinese domain standards heading"
  Require-Contains "scripts/check-derived-sync.sh" "TEMPLATE-BASE\.md" "check-derived-sync supports derived project template lineage"
  Require-Contains "scripts/check-derived-sync.ps1" "TEMPLATE-BASE\.md" "check-derived-sync PowerShell fallback supports template lineage"
  Require-Contains "scripts/check-derived-sync.sh" "Domain standards scope" "check-derived-sync validates domain TEMPLATE-BASE.md standards field"
  Require-Contains "scripts/check-derived-sync.ps1" "Domain standards scope" "check-derived-sync PowerShell fallback validates domain TEMPLATE-BASE.md standards field"
  ...
  Require-Contains "template-sync.json" "template-docs/web-app-scaffold-experiment\.md" "template-sync includes Web app scaffold experiment protocol"
  ...
  Require-Contains "scripts/sync-template.sh" "template-docs/web-app-scaffold-experiment\.md" "sync-template fallback includes Web app scaffold experiment protocol"
  ...
  Require-File "template-docs/web-app-scaffold-experiment.md"
  Require-Contains "template-docs/web-app-scaffold-experiment.md" "Promotion decision matrix" "Web app scaffold experiment protocol defines promotion matrix"
  Require-Contains "template-docs/web-app-scaffold-experiment.md" "不在母模板内直接生成" "Web app scaffold experiment protocol blocks direct scaffold in base template"
  Require-Contains "template-docs/web-fullstack-profile.md" "web-app-scaffold-experiment\.md" "Web fullstack profile links scaffold experiment protocol"
  Require-Contains "template-docs/domain-templates.md" "web-app-scaffold-experiment\.md" "domain template guidance references Web app scaffold experiments"
  Require-File "template-docs/capability-packages.md"
  Require-Contains "template-docs/capability-packages.md" "Remote / CI SOP Profile" "capability packages includes Remote / CI SOP profile"
  Require-Contains "template-docs/capability-packages.md" "不是 AI 每次任务的默认必读规则包" "capability packages stays non-default"
  Require-Contains "template-docs/capability-packages.md" "风险分级确认" "capability packages references risk-tier confirmation"
  Require-Contains "template-sync.json" "template-docs/capability-packages\.md" "template-sync includes capability packages guide"
  Require-Contains "scripts/sync-template.sh" "template-docs/capability-packages\.md" "sync-template fallback includes capability packages guide"
  ...
  Require-Contains "ai/rules-core.md" "默认进入 Checkpoint Mode" "core rules trigger Checkpoint Mode"
  Require-Contains "ai/rules-core.md" "风险分级确认" "core rules define Checkpoint Mode risk-tier confirmation"
  Require-Contains "ai/session-rules.md" "### 3\.3 Checkpoint Mode" "session rules define Checkpoint Mode"
  Require-Contains "ai/session-rules.md" "高风险单步确认" "session rules distinguish high-risk single-step confirmation"
  Require-Contains "git-guide.md" "远端 / CI / sandbox 防卡死策略" "git guide includes remote anti-hang strategy"
  Require-Contains "SOP.md" "GitHub 远端操作前预检与防卡死" "SOP indexes remote anti-hang entry"
